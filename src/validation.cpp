...
static unsigned int GetBlockScriptFlags(const CBlockIndex* pindex, const Consensus::Params& consensusparams) {
    ...
    if (IsBTCRWForkEnabled(consensusparams, pindex->pprev->nHeight)) {
...
bool IsBTCRWForkEnabled(const Consensus::Params& params, const int &height) {
    return height >= params.BTCRWForkHeight;
}

bool IsBTCRWForkHeight(const Consensus::Params& params, const int &height) {
    return params.BTCRWForkHeight == height;
}
